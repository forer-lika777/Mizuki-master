...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://blog.vista233.top", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "forer4433", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/forer-lika777",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/67117494",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "osu",
					url: "https://osu.ppy.sh/users/25399068",
					external: true,
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	// 侧栏组件布局配置
	components: {
		left: ["profile", "announcement", "tags", "cardtoc"],
